                        ...
                        <div class="card-body">
                            <form action="{{ isset($mentoring) ? route('admin.mentoring.update', $mentoring->id) : route('admin.mentoring.store') }}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('topik') is-invalid @enderror" id="topik" name="topik" placeholder="Contoh: Pembahasan Soal Ujian" value="{{ isset($mentoring) ? $mentoring->topik : '' }}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="time" class="form-control @error('jam') is-invalid @enderror" id="jam" name="jam" value="{{ isset($mentoring) ? \Carbon\Carbon::parse($mentoring->jam)->format('H:i') : '' }}" required>
