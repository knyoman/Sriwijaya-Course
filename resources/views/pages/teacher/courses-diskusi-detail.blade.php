    ...
    <main style="flex: 1; padding: 2rem; width: 100%; margin-left: 250px; padding-top: 70px;">
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <a href="{{ route('teacher.courses.diskusi.index', $course->id) }}" class="btn btn-secondary btn-sm">Kembali ke Diskusi</a>
            </div>
                ...
                <div class="col-md-8">
                    ...
                    <div class="card shadow-sm" style="height: 600px; display: flex; flex-direction: column;">
                        ...
                        <div class="card-footer bg-white border-top">
                            <form action="{{ route('teacher.courses.diskusi.balasan.store', [$course->id, $diskusi->id]) }}" method="POST">
                                @csrf
